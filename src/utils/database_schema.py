...
def create_star_schema():
    ...
    engine = sqlalchemy.create_engine(f"postgresql+psycopg2://{spotify.docker_constants.POSTGRES_USER}:{spotify.docker_constants.POSTGRES_PASSWORD}@localhost:5432/{spotify.docker_constants.POSTGRES_DB}")
